...
public class PictureChatService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        return new IPictureChatServer.Stub() {
            ...
            @Override
            public ParcelFileDescriptor requestPicturePut(ISigmaManager remote, PictureEntry entry) throws RemoteException {
                String from;
                if (remote != null) {
            ...
            @Override
            public PictureEntry requestPictureGet(ISigmaManager remote, String uuid, ParcelFileDescriptor writeTo) throws RemoteException {
