...
public class RemoteContext {
    ...
    private IBinder getServiceAsBinder(String name) {
        try {
            Method getServiceMethod = mRemoteServiceManager.getClass().getMethod("getService", String.class);
        ...
        if (name.equals(Context.LOCATION_SERVICE)) {
            ...
            try {
                ...
                Object locationManager = Class.forName("android.location.LocationManager")
                        .getDeclaredConstructor(Context.class, Class.forName("android.location.ILocationManager"))
